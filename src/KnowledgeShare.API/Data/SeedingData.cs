...
namespace KnowledgeShare.API.Data
{
    public class SeedingData
    {
        ...
        public SeedingData(ApplicationDbContext context, UserManager<User> userManager, RoleManager<IdentityRole> roleManager)
        {
            _context = context;
        ...
        public async Task Seed()
        {
            ...
            if (!_context.Functions.Any())
            {
                _context.Functions.AddRange(new List<Function>
                {
                    ...
                    new Function { Id = "CONTENT", Name = "Nội dung", ParentId = null, SortOrder = 1, Url = "/content"},

                    new Function { Id = "CONTENT_CATEGORY", Name = "Danh mục", ParentId = "CONTENT", Url = "/content/category"},
                    new Function { Id = "CONTENT_KNOWLEDGEBASE", Name = "Bài viết", ParentId = "CONTENT", SortOrder = 2, Url = "/content/knowledgebase"},
                    ...
                    new Function { Id = "STATISTIC_MONTHLY_NEWKNOWLEDGEBASE", Name = "Bài đăng hàng ngày", ParentId = "STATISTIC", SortOrder = 2, Url = "/statistic/monthly-newknowledgebase"},
                    new Function { Id = "STATISTIC_MONTHLY_COMMENT", Name = "Comment theo ngày", ParentId = "STATISTIC", SortOrder = 3, Url = "/statistic/monthly-comment"},
